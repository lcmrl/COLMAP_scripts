...
#
# Used in first experiments without GT
# python SequentialCrossCorr.py -pw 33 -ph 33 -i ./tests/GlassCylinder/imgs -k ./tests/GlassCylinder/tentative_kpts -o ./tests/GlassCylinder/colmap_kpts -s True
...
STATIC_KPTS_THRESHOLD = 0
SEARCHING_WINDOW_WIDTH_AMPLIFICATION_FACTOR = 2.5
SEARCHING_WINDOW_HEIGHT_AMPLIFICATION_FACTOR= 10 #18
NCC_REJECT_THRESHOLD = 0.1
...
def NCC(ref, templ, silent):
    ...
    max_ncc = np.max(ncc_matrix)
    autocorrelation_ncc = np.sum((templ-templ.mean())*(templ-templ.mean()))/(templ.std()*templ.std()+EPSILON)
    #templ_pil = Image.fromarray(templ); templ_pil.show()
    
    ncc_matrix = ncc_matrix / np.max(ncc_matrix) * 255.0
    
    #if silent == 'False': ncc_matrix = Image.fromarray(ncc_matrix)
    #if silent == 'False': ncc_matrix.show()
    #if silent == 'False': a = y+int((templ_row-1)/2)
    #if silent == 'False': b = x+int((templ_col-1)/2)
    #if silent == 'False': ref = Image.fromarray(ref)
    #if silent == 'False': ref = ref.convert('RGB')
    #if silent == 'False': draw = ImageDraw.Draw(ref)
    #if silent == 'False': draw.point((b,a),fill=(255,0,0))
    ##if silent == 'False': ref[a, b] = 0
    #if silent == 'False': ref.show()
    
    y, x = y+int((templ_row-1)/2), x+int((templ_col-1)/2)

    return y, x, max_ncc, autocorrelation_ncc
...
def SequentialCrossCorrelation(initial_kpt, target_image, img_folder, patch_width, patch_hight, silent, img_list):
    ...
    #img_list = os.listdir(img_folder)
    #img_list.sort()
    #img_list = ["pos0_cam0.jpg", "pos1_cam0.jpg", "pos2_cam0.jpg", "pos3_cam0.jpg", "pos4_cam0.jpg", "pos5_cam0.jpg", "pos6_cam0.jpg", "pos7_cam0.jpg", "pos8_cam0.jpg", "pos9_cam0.jpg", "pos10_cam0.jpg", "pos11_cam0.jpg", "pos12_cam0.jpg", "pos13_cam0.jpg", "pos14_cam0.jpg", "pos15_cam0.jpg", "pos16_cam0.jpg", "pos17_cam0.jpg", "pos18_cam0.jpg", "pos19_cam0.jpg", "pos20_cam0.jpg", "pos21_cam0.jpg", "pos22_cam0.jpg", "pos23_cam0.jpg", "pos24_cam0.jpg", "pos25_cam0.jpg", "pos26_cam0.jpg", "pos27_cam0.jpg", "pos28_cam0.jpg", "pos29_cam0.jpg", "pos30_cam0.jpg", "pos31_cam0.jpg", "pos32_cam0.jpg", "pos33_cam0.jpg", "pos34_cam0.jpg", "pos35_cam0.jpg"]
    ...
    y, x, max_ncc, autocorrelation_ncc = NCC(searching_window, template_patch, silent)
    ...
    return X, Y, max_ncc, autocorrelation_ncc


def Tracking(tentative_kpts, img_folder, img_dict, patch_width, patch_hight, silent, img_list): # TODO si potrebbe ciclare su patch successive aggiorando la patch reference con quella appena trovata e così via
    
    track_dict = {}
    t = 0
    img_dict_reverse = {a:b for a, b in zip(img_dict.values(), img_dict.keys())}
    print("img_dict_reverse", img_dict_reverse)
    print("tentative_kpts", tentative_kpts)
    ...
    for kp in tentative_kpts:
        ...
        for c in candidate_images:
            ...
            x, y, max_ncc, autocorrelation_ncc = SequentialCrossCorrelation(kp, target_im, img_folder, patch_width, patch_hight, silent, img_list)
            if np.absolute(x-kp[1])>=STATIC_KPTS_THRESHOLD and np.absolute(y-kp[2])>=STATIC_KPTS_THRESHOLD and max_ncc/autocorrelation_ncc>NCC_REJECT_THRESHOLD:
                current_track.append((target_im , x, y))
                #print("max_ncc, NCC_REJECT_THRESHOLD: {}, {}".format(max_ncc, NCC_REJECT_THRESHOLD))
                #print("autocorrelation_ncc: {}".format(autocorrelation_ncc))
                print('Ratio max_ncc/autocorrelation_ncc:   {}'.format(max_ncc/autocorrelation_ncc))
            else:
...
def main():
    ...
    #img_list = os.listdir(img_folder)
    #img_list.sort()
    img_list = ["00_pos0_cam0.jpg", "01_pos1_cam0.jpg", "02_pos2_cam0.jpg", "03_pos3_cam0.jpg", "04_pos4_cam0.jpg", "05_pos5_cam0.jpg", "06_pos6_cam0.jpg", "07_pos7_cam0.jpg", "08_pos8_cam0.jpg", "09_pos9_cam0.jpg", "10_pos10_cam0.jpg", "11_pos11_cam0.jpg", "12_pos12_cam0.jpg", "13_pos13_cam0.jpg", "14_pos14_cam0.jpg", "15_pos15_cam0.jpg", "16_pos16_cam0.jpg", "17_pos17_cam0.jpg", "18_pos18_cam0.jpg", "19_pos19_cam0.jpg", "20_pos20_cam0.jpg", "21_pos21_cam0.jpg", "22_pos22_cam0.jpg", "23_pos23_cam0.jpg", "24_pos24_cam0.jpg", "25_pos25_cam0.jpg", "26_pos26_cam0.jpg", "27_pos27_cam0.jpg", "28_pos28_cam0.jpg", "29_pos29_cam0.jpg", "30_pos30_cam0.jpg", "31_pos31_cam0.jpg", "32_pos32_cam0.jpg", "33_pos33_cam0.jpg", "34_pos34_cam0.jpg", "35_pos35_cam0.jpg"]
    ...
    images_with_kpts = ["00_pos0_cam0.jpg.txt","02_pos2_cam0.jpg.txt","04_pos4_cam0.jpg.txt","06_pos6_cam0.jpg.txt","08_pos8_cam0.jpg.txt"] #"00_pos0_cam0.jpg.txt", "01_pos1_cam0.jpg.txt", "02_pos2_cam0.jpg.txt", "03_pos3_cam0.jpg.txt", "04_pos4_cam0.jpg.txt", "05_pos5_cam0.jpg.txt", "06_pos6_cam0.jpg.txt", "07_pos7_cam0.jpg.txt", "08_pos8_cam0.jpg.txt", "09_pos9_cam0.jpg.txt", "10_pos10_cam0.jpg.txt", "11_pos11_cam0.jpg.txt", "12_pos12_cam0.jpg.txt", "13_pos13_cam0.jpg.txt", "14_pos14_cam0.jpg.txt", "15_pos15_cam0.jpg.txt", "16_pos16_cam0.jpg.txt", "17_pos17_cam0.jpg.txt", "18_pos18_cam0.jpg.txt", "19_pos19_cam0.jpg.txt", "20_pos20_cam0.jpg.txt", "21_pos21_cam0.jpg.txt", "22_pos22_cam0.jpg.txt", "23_pos23_cam0.jpg.txt", "24_pos24_cam0.jpg.txt", "25_pos25_cam0.jpg.txt", "26_pos26_cam0.jpg.txt", "27_pos27_cam0.jpg.txt", "28_pos28_cam0.jpg.txt", "29_pos29_cam0.jpg.txt", "30_pos30_cam0.jpg.txt", "31_pos31_cam0.jpg.txt", "32_pos32_cam0.jpg.txt", "33_pos33_cam0.jpg.txt", "34_pos34_cam0.jpg.txt", "35_pos35_cam0.jpg.txt"
    tentative_kpts = []
    ...
    track_dict = Tracking(tentative_kpts, img_folder, img_dict, patch_width, patch_hight, silent, img_list)
    ...
    for track in track_dict:
        track_dict[track].sort(key = lambda element : element[0])
        #print("track", track_dict[track]); quit()
